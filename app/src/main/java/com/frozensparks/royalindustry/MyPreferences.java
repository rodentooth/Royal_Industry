...
/**
 * Created by Emanuel Graf on 06.06.2016.
 */
...
public class MyPreferences {
    ...
    public MyPreferences(Context context, String preferenceName,
    ...
    public static MyPreferences getInstance(Context contxt,String prefName) {
        if (instance == null) {
            instance = new MyPreferences(contxt, prefName,
                    prefName+"Key", true);
        }
        return instance;
    }
    ...
    public void putFloat(String key, float value) {
        ...
        putValue(toKey(key), Float.toString(value));
    ...
    public float getFloat(String key, float value)
        ...
        if (preferences.contains(toKey(key))) {
            String securedEncodedValue = preferences.getString(toKey(key), "");
            return  Float.parseFloat(decrypt(securedEncodedValue));
        }
        return value;
    }
